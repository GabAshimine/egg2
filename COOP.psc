...
Algoritmo sin_titulo
	Definir user,pass , decision Como Caracter
	Definir intentos Como Entero
	Definir login  Como Logico
	Definir saldo, botellas, peso, saldoActual como real
	saldo=0;
	botellas=0;
	peso=0
	user=""
	...
	Mientras intentos<=3 y login=Falso
		...
		Leer user
		Escribir "Ingrese la contraseña valido"
		Leer pass
	...
	Hacer
		si	opciones=1
			...
			Para peso=100 Hasta 3000 Con Paso 100 Hacer
				si peso <=500
					escribir "Su saldo será de $50"
					 saldo=50
					si peso >500 y peso <=1500
						escribir "Su saldo será de $125"
						saldo=125
					FinSi
					si peso >1500
						escribir "Su saldo será de $200"
					saldo=200
						
					FinSi
					escribir "Acepta esta cantidad de dinero?"
					
					leer decision 
					si decision= Mayusculas("si") 
							
						saldoActual=  saldo+ saldo
						escribir "Su saldo actual es", saldoActual
					SiNo
						escribir "Devolviendo material"
						escribir "Para ingresar botellas ingrese 1"
						escribir "Para consultar su saldo ingrese 2"
						escribir "Para salir ingrese 3"
						opciones=0
					FinSi
					
				FinSi
				//escribir "Por sus ", peso "gramos de botellas le ofrecemos $", saldo
